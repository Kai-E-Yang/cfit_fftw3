...
np.transpose(bz).astype('float64').tofile('./data/bz0.dat')
np.transpose(alpha).astype('float64').tofile('./data/alpha0.dat')
np.transpose(sig).astype('float64').tofile('./data/sig0.dat')
